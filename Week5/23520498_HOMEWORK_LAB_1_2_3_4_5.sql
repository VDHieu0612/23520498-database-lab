...
GROUP BY TenCongTy, DuAn.MaCongTy
ORDER BY TenCongTy
...
/*BUOI 5*/
GO
CREATE TRIGGER trg_kiem_tra_ngay_du_an ON DuAn
AFTER INSERT, UPDATE
AS
BEGIN
    IF EXISTS (
    ...
    BEGIN
        ...
        PRINT N'Lỗi: Ngày kết thúc phải lớn hơn ngày bắt đầu.';
...
INSERT INTO DuAn (MaDuAn, TenDuAn, MaCongTy, NgayBatDau, NgayKetThuc, TrangThai)
VALUES (11, N'Dự án A', 1, '2024-12-01', '2024-12-10', N'Đang thực hiện');

INSERT INTO DuAn (MaDuAn, TenDuAn, MaCongTy, NgayBatDau, NgayKetThuc, TrangThai)
VALUES (100, N'Dự án B', 1, '2024-12-10', '2024-12-01', N'Hoàn thành');

SELECT * FROM DuAn
UPDATE DuAn
SET NgayBatDau = '2024-12-11'
WHERE MaDuAn = '11'
-----------------------------------------------------------------------------------------------------
