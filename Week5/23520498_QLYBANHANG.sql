...
--câu 12
GO
CREATE TRIGGER trg_ins_hdcau12 ON HOADON
AFTER INSERT
AS
BEGIN
...
--câu 13
GO
CREATE TRIGGER ins_hd_cau13 ON HOADON
AFTER UPDATE
AS
BEGIN
    DECLARE @sohd INT
...
GO
CREATE TRIGGER upd_cthd_cau13 ON CTHD
AFTER UPDATE
AS
BEGIN
...
GO
CREATE OR ALTER TRIGGER ins_cthd_cau13 ON CTHD
AFTER INSERT
AS
BEGIN
...
GO
CREATE OR ALTER TRIGGER del_cthd_cau13 ON CTHD
AFTER DELETE
AS
BEGIN
	DECLARE @SOHD INT, @SL INT, @GIA MONEY, @MASP CHAR(4), @TONGTRIGIA MONEY
